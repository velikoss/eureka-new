...
<div class="w-screen h-screen flex flex-col items-center justify-center">
    ...
    <form method="POST" class="border w-90 flex flex-col px-6 pb-6 gap-3 rounded-2xl shadow-lg motion-preset-blur-down">
        ...
        <div class="relative">
            ...
            <label for="floating_outlined" class="pointer-events-none absolute text-sm text-gray-500 dark:text-gray-200 duration-200 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white dark:bg-black px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 start-1 flex flex-row gap-2.5"><User/> Login (@edu.mirea.ru)</label>
        </div>
        <div class="relative">
            ...
            <label for="floating_outlined" class="pointer-events-none absolute text-sm text-gray-500 dark:text-gray-200 duration-200 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white dark:bg-black px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 start-1 flex flex-row gap-2.5"><RectangleEllipsis /> Password</label>
        </div>
        <button class="border w-fit mt-2 px-5 py-1 self-center rounded-md cursor-grab flex flex-row items-center justify-center gap-2.5">
            <LogIn size={16} />
            Log in
        </button>
    </form>
    <div class="pt-3 text-xs flex flex-row items-center gap-2 motion-preset-blur-down motion-delay-200">
        Eureka v0.1.0

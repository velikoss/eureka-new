...
export const eurekaNews: News[] = [
    {
        ...
        Столкнулись с баном от создателей Авроры, из-за чего могут возникнуть некоторые замедления со стороны работы системы.<br>
        Следующее мажорное обновления будет на днях, ожидайте.
        `,
        "date_add": "1745322065"
    },
    {
